...
vignette: >
  %\VignetteIndexEntry{kinetics_overview}
...
```{r, rpe_plot, fig.width=12, fig.height=10, dpi=300, units="cm"}
sum(is.na(rpe_scores))
...
```{r, rpe_plot_rebuttal, fig.width=12, fig.height=10, dpi=300, units="cm"}
...
```{r, individual_heatmaps, fig.show='hide'}
